...
public class p_master extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.p_master_a);
        ...
        for (int i = 0 ; i <= (size-1); i++) {
            ...
            bt[i].setOnClickListener(new View.OnClickListener() { //전화하면서 될까요?
                ...
                public void onClick(View v) {
                    ...
                    new JSONTask().execute("http://192.168.200.152:4000/auth/delete");
                }
            });
        }
    }
    ...
    public class JSONTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... urls) {
            try {
                ...
                jsonObject.put("student", tx[count-1].getText().toString());
                jsonObject.put("jjj", jjj);
